mkdir -p output/chip-pipeline-GRCm38_GSE44286_B

chipseq.py -j slurm -s '1-10,12' \
    -l debug \
    -r raw/chip-seq/readset_GSE44286_B.txt \
    -d raw/chip-seq/design_GSE44286_B.txt \
    -o output/chip-pipeline-GRCm38_GSE44286_B \
