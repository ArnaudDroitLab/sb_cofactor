mkdir -p output/chip-pipeline-GRCm38_GSE30267

chipseq.py -j slurm -s '1-10,12' \
    -l debug \
    -r raw/chip-seq/readset_GSE30267.txt \
    -d raw/chip-seq/design_GSE30267.txt \
    -o output/chip-pipeline-GRCm38_GSE30267 \
