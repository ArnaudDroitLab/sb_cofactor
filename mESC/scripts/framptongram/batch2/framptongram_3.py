...
file_list = get_filename("/home/chris/Bureau/sb_cofactor_hr/mESC/scripts/framptongram/bed_file_path_merged_replicate.txt")
list_chrom_regions = []
for filename in file_list:
	list_chrom_regions.append( read_chrom_regions( filename ) )

outfile = open( '/home/chris/Bureau/sb_cofactor_hr/mESC/scripts/framptongram/comparison_matrix_20190408_mergedreplicate.txt', 'w' )
