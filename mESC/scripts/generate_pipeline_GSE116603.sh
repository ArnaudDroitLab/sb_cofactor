mkdir -p output/chip-pipeline-GRCm38_GSE116603

chipseq.py -j slurm -s '1-10,12' \
    -l debug \
    -r raw/chip-seq/readset_GSE116603.txt \
    -d raw/chip-seq/design_GSE116603.txt \
    -o output/chip-pipeline-GRCm38_GSE116603 \
