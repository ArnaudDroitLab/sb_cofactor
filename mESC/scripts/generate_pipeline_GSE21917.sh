mkdir -p output/chip-pipeline-GRCm38_GSE21917

chipseq.py -j slurm -s '1-10,12' \
    -l debug \
    -r raw/chip-seq/readset_GSE21917.txt \
    -d raw/chip-seq/design_GSE21917.txt \
    -o output/chip-pipeline-GRCm38_GSE21917 \
