mkdir -p output/chip-pipeline-GRCm38_GSE11431

chipseq.py -j slurm -s '1-10,12' \
    -l debug \
    -r raw/chip-seq/readset_GSE11431.txt \
    -d raw/chip-seq/design_GSE11431.txt \
    -o output/chip-pipeline-GRCm38_GSE11431 \
