...
# Version: 3.0.1-beta
# Created on: 2018-04-20T15:36:46
# Steps:
#   picard_sam_to_fastq: 2 jobs
#   trimmomatic: 2 jobs
...
JOB_DEPENDENCIES=
JOB_DONE=job_output/picard_sam_to_fastq/picard_sam_to_fastq.DEX_nonMamm_1_1.32659145bf2b0c458df9a975e24112d8.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'picard_sam_to_fastq.DEX_nonMamm_1_1.32659145bf2b0c458df9a975e24112d8.mugqic.done'
module load java/1.8.0_121 mugqic/picard/2.9.0 && \
java -Djava.io.tmpdir=${SLURM_TMPDIR} -XX:ParallelGCThreads=4 -Dsamjdk.buffer_size=1048576 -Xmx15G -jar $PICARD_HOME/picard.jar SamToFastq \
 VALIDATION_STRINGENCY=LENIENT \
 INPUT=/project/6001942/Working_Directory/Eric/CofactorHR/A549/raw/rna-seq/HI.2031.002.Index_3.SB_A549-DEX-nonMamm.bam \
 FASTQ=/project/6001942/Working_Directory/Eric/CofactorHR/A549/raw/rna-seq/HI.2031.002.Index_3.SB_A549-DEX-nonMamm.pair1.fastq.gz \
  SECOND_END_FASTQ=/project/6001942/Working_Directory/Eric/CofactorHR/A549/raw/rna-seq/HI.2031.002.Index_3.SB_A549-DEX-nonMamm.pair2.fastq.gz
picard_sam_to_fastq.DEX_nonMamm_1_1.32659145bf2b0c458df9a975e24112d8.mugqic.done
)
...
echo '#######################################'
exit \$MUGQIC_STATE" | \
sbatch --mail-type=END,FAIL --mail-user=$JOB_MAIL -A $RAP_ID -D $OUTPUT_DIR -o $JOB_OUTPUT -J $JOB_NAME --time=24:00:00 --mem=16G -N 1 -n 4 | grep "[0-9]" | cut -d\  -f4)
...
JOB_DEPENDENCIES=
JOB_DONE=job_output/picard_sam_to_fastq/picard_sam_to_fastq.DEX_nonMamm_1_2.f95679c5eef95ca4602dc19baf01ab11.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'picard_sam_to_fastq.DEX_nonMamm_1_2.f95679c5eef95ca4602dc19baf01ab11.mugqic.done'
module load java/1.8.0_121 mugqic/picard/2.9.0 && \
java -Djava.io.tmpdir=${SLURM_TMPDIR} -XX:ParallelGCThreads=4 -Dsamjdk.buffer_size=1048576 -Xmx15G -jar $PICARD_HOME/picard.jar SamToFastq \
 VALIDATION_STRINGENCY=LENIENT \
 INPUT=/project/6001942/Working_Directory/Eric/CofactorHR/A549/raw/rna-seq/HI.2031.003.Index_3.SB_A549-DEX-nonMamm.bam \
 FASTQ=/project/6001942/Working_Directory/Eric/CofactorHR/A549/raw/rna-seq/HI.2031.003.Index_3.SB_A549-DEX-nonMamm.pair1.fastq.gz \
  SECOND_END_FASTQ=/project/6001942/Working_Directory/Eric/CofactorHR/A549/raw/rna-seq/HI.2031.003.Index_3.SB_A549-DEX-nonMamm.pair2.fastq.gz
picard_sam_to_fastq.DEX_nonMamm_1_2.f95679c5eef95ca4602dc19baf01ab11.mugqic.done
)
...
JOB_DONE=job_output/trimmomatic/trimmomatic.DEX_nonMamm_1_2.233eb141c8dcd65b9a626d14bcb15455.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'trimmomatic.DEX_nonMamm_1_2.233eb141c8dcd65b9a626d14bcb15455.mugqic.done'
module load java/1.8.0_121 mugqic/trimmomatic/0.36 && \
mkdir -p trim/DEX_nonMamm_1 && \
java -XX:ParallelGCThreads=1 -Xmx2G -jar $TRIMMOMATIC_JAR PE \
  -threads 6 \
  -phred33 \
  /project/6001942/Working_Directory/Eric/CofactorHR/A549/raw/rna-seq/HI.2031.003.Index_3.SB_A549-DEX-nonMamm.pair1.fastq.gz \
  /project/6001942/Working_Directory/Eric/CofactorHR/A549/raw/rna-seq/HI.2031.003.Index_3.SB_A549-DEX-nonMamm.pair2.fastq.gz \
...
trimmomatic.DEX_nonMamm_1_2.233eb141c8dcd65b9a626d14bcb15455.mugqic.done
)
...
JOB_DONE=job_output/merge_trimmomatic_stats/merge_trimmomatic_stats.66d6593ac346b186093be528bd5dd3cf.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'merge_trimmomatic_stats.66d6593ac346b186093be528bd5dd3cf.mugqic.done'
...
merge_trimmomatic_stats.66d6593ac346b186093be528bd5dd3cf.mugqic.done
)
...
JOB_DONE=job_output/star/star_align.1.DEX_nonMamm_1_1.1b03d02dc14fe1f2de45e2a0a4e080aa.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'star_align.1.DEX_nonMamm_1_1.1b03d02dc14fe1f2de45e2a0a4e080aa.mugqic.done'
...
star_align.1.DEX_nonMamm_1_1.1b03d02dc14fe1f2de45e2a0a4e080aa.mugqic.done
)
...
JOB_DONE=job_output/star/star_align.1.DEX_nonMamm_1_2.318fa5019422056ce23126cdc8af47fa.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'star_align.1.DEX_nonMamm_1_2.318fa5019422056ce23126cdc8af47fa.mugqic.done'
module load mugqic/star/2.5.3a && \
...
STAR --runMode alignReads \
  ...
  --limitGenomeGenerateRAM 100000000000 \
  --limitIObufferSize 4000000000
star_align.1.DEX_nonMamm_1_2.318fa5019422056ce23126cdc8af47fa.mugqic.done
)
...
JOB_DONE=job_output/star/star_index.AllSamples.6d58e1c10df17ccef08597e3d497286c.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'star_index.AllSamples.6d58e1c10df17ccef08597e3d497286c.mugqic.done'
module load mugqic/star/2.5.3a && \
cat \
...
STAR --runMode genomeGenerate \
  ...
  --sjdbOverhang 99
star_index.AllSamples.6d58e1c10df17ccef08597e3d497286c.mugqic.done
)
...
#-------------------------------------------------------------------------------
# JOB: star_4_JOB_ID: star_align.2.HI.4620.001.NEBNext_Index_12.A549_RNA_NA_shNIPBL-3_Dex_Rep2
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# JOB: star_5_JOB_ID: star_align.2.HI.4620.001.NEBNext_Index_19.A549_RNA_NA_shMED1-2_Dex_Rep2
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# JOB: star_6_JOB_ID: star_align.2.HI.4620.001.NEBNext_Index_1.A549_RNA_NA_shSMC1A-2_Dex_Rep2
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# JOB: star_7_JOB_ID: star_align.2.HI.4620.001.NEBNext_Index_5.A549_RNA_NA_shCRTL-2_Dex_Rep2
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# JOB: star_8_JOB_ID: star_align.2.DEX_nonMamm_1_1
#-------------------------------------------------------------------------------
JOB_NAME=star_align.2.DEX_nonMamm_1_1
JOB_DEPENDENCIES=$trimmomatic_1_JOB_ID:$star_3_JOB_ID
JOB_DONE=job_output/star/star_align.2.DEX_nonMamm_1_1.c6789b20f8b3a0ad1fe877778965b0ce.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'star_align.2.DEX_nonMamm_1_1.c6789b20f8b3a0ad1fe877778965b0ce.mugqic.done'
module load mugqic/star/2.5.3a && \
...
STAR --runMode alignReads \
  ...
  --outWigType wiggle read1_5p --outWigStrand Stranded --outWigReferencesPrefix chr \
  --chimSegmentMin 21
star_align.2.DEX_nonMamm_1_1.c6789b20f8b3a0ad1fe877778965b0ce.mugqic.done
)
...
#-------------------------------------------------------------------------------
# JOB: star_9_JOB_ID: star_align.2.DEX_nonMamm_1_2
#-------------------------------------------------------------------------------
JOB_NAME=star_align.2.DEX_nonMamm_1_2
JOB_DEPENDENCIES=$trimmomatic_2_JOB_ID:$star_3_JOB_ID
JOB_DONE=job_output/star/star_align.2.DEX_nonMamm_1_2.b1b5e30f03a7e2d81d008115b94eb4a0.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'star_align.2.DEX_nonMamm_1_2.b1b5e30f03a7e2d81d008115b94eb4a0.mugqic.done'
module load mugqic/star/2.5.3a && \
...
STAR --runMode alignReads \
  ...
  --outWigType wiggle read1_5p --outWigStrand Stranded --outWigReferencesPrefix chr \
  --chimSegmentMin 21
star_align.2.DEX_nonMamm_1_2.b1b5e30f03a7e2d81d008115b94eb4a0.mugqic.done
)
...
JOB_DEPENDENCIES=$star_4_JOB_ID:$star_5_JOB_ID:$star_6_JOB_ID:$star_7_JOB_ID:$star_8_JOB_ID:$star_9_JOB_ID
...
JOB_DEPENDENCIES=$star_8_JOB_ID:$star_9_JOB_ID
