...
# Version: 2.2.1-beta
# Created on: 2017-05-15T18:35:03
# Steps:
...
JOB_DONE=job_output/star/star_align.1.DEX_shSMC1A_1_1.0690bc2c6d9d68c856b1783efaf49c28.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'star_align.1.DEX_shSMC1A_1_1.0690bc2c6d9d68c856b1783efaf49c28.mugqic.done'
module load mugqic/star/2.5.1b && \
...
STAR --runMode alignReads \
  ...
  --limitGenomeGenerateRAM 70000000000 \
  --limitIObufferSize 1000000000
star_align.1.DEX_shSMC1A_1_1.0690bc2c6d9d68c856b1783efaf49c28.mugqic.done
)
...
JOB_DONE=job_output/star/star_align.1.DEX_shSMC1A_1_2.b325e51599578d49d3178ac4d1d56934.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'star_align.1.DEX_shSMC1A_1_2.b325e51599578d49d3178ac4d1d56934.mugqic.done'
module load mugqic/star/2.5.1b && \
...
STAR --runMode alignReads \
  ...
  --limitGenomeGenerateRAM 70000000000 \
  --limitIObufferSize 1000000000
star_align.1.DEX_shSMC1A_1_2.b325e51599578d49d3178ac4d1d56934.mugqic.done
)
...
JOB_DONE=job_output/star/star_align.1.ETOH_shSMC1A_1_1.0b9b45bcebf438be178e7a131b935da5.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'star_align.1.ETOH_shSMC1A_1_1.0b9b45bcebf438be178e7a131b935da5.mugqic.done'
module load mugqic/star/2.5.1b && \
...
STAR --runMode alignReads \
  ...
  --limitGenomeGenerateRAM 70000000000 \
  --limitIObufferSize 1000000000
star_align.1.ETOH_shSMC1A_1_1.0b9b45bcebf438be178e7a131b935da5.mugqic.done
)
...
JOB_DONE=job_output/star/star_align.1.ETOH_shSMC1A_1_2.30e00647d28c31cae08d0dfe5d7a46e3.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'star_align.1.ETOH_shSMC1A_1_2.30e00647d28c31cae08d0dfe5d7a46e3.mugqic.done'
module load mugqic/star/2.5.1b && \
...
STAR --runMode alignReads \
  ...
  --limitGenomeGenerateRAM 70000000000 \
  --limitIObufferSize 1000000000
star_align.1.ETOH_shSMC1A_1_2.30e00647d28c31cae08d0dfe5d7a46e3.mugqic.done
)
...
JOB_DONE=job_output/star/star_index.AllSamples.a55271050368ab8332d374e688726ef6.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'star_index.AllSamples.a55271050368ab8332d374e688726ef6.mugqic.done'
module load mugqic/star/2.5.1b && \
cat \
...
STAR --runMode genomeGenerate \
  ...
  --limitIObufferSize 1000000000 \
  --sjdbOverhang 99
star_index.AllSamples.a55271050368ab8332d374e688726ef6.mugqic.done
)
...
JOB_DONE=job_output/picard_rna_metrics/picard_rna_metrics.DEX_shSMC1A_3.f214d0409469aa2f6a82aae5252d5225.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'picard_rna_metrics.DEX_shSMC1A_3.f214d0409469aa2f6a82aae5252d5225.mugqic.done'
module load mugqic/java/openjdk-jdk1.8.0_72 mugqic/picard/2.0.1 mugqic/R_Bioconductor/3.2.3_3.2 && \
...
java -Djava.io.tmpdir=/gs/scratch/$USER -XX:ParallelGCThreads=4 -Xmx27G -jar $PICARD_HOME/picard.jar CollectRnaSeqMetrics \
 ...
 REFERENCE_SEQUENCE=$MUGQIC_INSTALL_HOME/genomes/species/Homo_sapiens.hg19/genome/Homo_sapiens.hg19.fa \
 MAX_RECORDS_IN_RAM=5750000
picard_rna_metrics.DEX_shSMC1A_3.f214d0409469aa2f6a82aae5252d5225.mugqic.done
)
...
JOB_DONE=job_output/picard_rna_metrics/picard_rna_metrics.ETOH_shSMC1A_3.ea45148f0cf8342c60c888d4a2700979.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'picard_rna_metrics.ETOH_shSMC1A_3.ea45148f0cf8342c60c888d4a2700979.mugqic.done'
module load mugqic/java/openjdk-jdk1.8.0_72 mugqic/picard/2.0.1 mugqic/R_Bioconductor/3.2.3_3.2 && \
...
java -Djava.io.tmpdir=/gs/scratch/$USER -XX:ParallelGCThreads=4 -Xmx27G -jar $PICARD_HOME/picard.jar CollectRnaSeqMetrics \
 ...
 REFERENCE_SEQUENCE=$MUGQIC_INSTALL_HOME/genomes/species/Homo_sapiens.hg19/genome/Homo_sapiens.hg19.fa \
 MAX_RECORDS_IN_RAM=5750000
picard_rna_metrics.ETOH_shSMC1A_3.ea45148f0cf8342c60c888d4a2700979.mugqic.done
)
...
JOB_DONE=job_output/estimate_ribosomal_rna/bwa_mem_rRNA.DEX_shSMC1A_1_1.53895ba306f11e7889eff8d7d037a67a.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'bwa_mem_rRNA.DEX_shSMC1A_1_1.53895ba306f11e7889eff8d7d037a67a.mugqic.done'
module load mugqic/java/openjdk-jdk1.8.0_72 mugqic/bvatools/1.6 mugqic/bwa/0.7.12 mugqic/picard/2.0.1 mugqic/mugqic_tools/2.1.7 mugqic/python/2.7.13 && \
...
python $PYTHON_TOOLS/rrnaBAMcounter.py \
  ...
  -t transcript
bwa_mem_rRNA.DEX_shSMC1A_1_1.53895ba306f11e7889eff8d7d037a67a.mugqic.done
)
...
JOB_DONE=job_output/estimate_ribosomal_rna/bwa_mem_rRNA.DEX_shSMC1A_1_2.ff2e33e0f21ed13da53df76f25f987d8.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'bwa_mem_rRNA.DEX_shSMC1A_1_2.ff2e33e0f21ed13da53df76f25f987d8.mugqic.done'
module load mugqic/java/openjdk-jdk1.8.0_72 mugqic/bvatools/1.6 mugqic/bwa/0.7.12 mugqic/picard/2.0.1 mugqic/mugqic_tools/2.1.7 mugqic/python/2.7.13 && \
...
python $PYTHON_TOOLS/rrnaBAMcounter.py \
  ...
  -t transcript
bwa_mem_rRNA.DEX_shSMC1A_1_2.ff2e33e0f21ed13da53df76f25f987d8.mugqic.done
)
...
JOB_DONE=job_output/estimate_ribosomal_rna/bwa_mem_rRNA.ETOH_shSMC1A_1_1.ad47ba275d99ba3a6cd4c8da1f5541bd.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'bwa_mem_rRNA.ETOH_shSMC1A_1_1.ad47ba275d99ba3a6cd4c8da1f5541bd.mugqic.done'
module load mugqic/java/openjdk-jdk1.8.0_72 mugqic/bvatools/1.6 mugqic/bwa/0.7.12 mugqic/picard/2.0.1 mugqic/mugqic_tools/2.1.7 mugqic/python/2.7.13 && \
...
python $PYTHON_TOOLS/rrnaBAMcounter.py \
  ...
  -t transcript
bwa_mem_rRNA.ETOH_shSMC1A_1_1.ad47ba275d99ba3a6cd4c8da1f5541bd.mugqic.done
)
...
JOB_DONE=job_output/estimate_ribosomal_rna/bwa_mem_rRNA.ETOH_shSMC1A_1_2.d48de6e520233f113b5d0303d210c64d.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'bwa_mem_rRNA.ETOH_shSMC1A_1_2.d48de6e520233f113b5d0303d210c64d.mugqic.done'
module load mugqic/java/openjdk-jdk1.8.0_72 mugqic/bvatools/1.6 mugqic/bwa/0.7.12 mugqic/picard/2.0.1 mugqic/mugqic_tools/2.1.7 mugqic/python/2.7.13 && \
...
python $PYTHON_TOOLS/rrnaBAMcounter.py \
  ...
  -t transcript
bwa_mem_rRNA.ETOH_shSMC1A_1_2.d48de6e520233f113b5d0303d210c64d.mugqic.done
)
...
JOB_DONE=job_output/rnaseqc/rnaseqc.ab7c51d6d975aac6830f121adb72441a.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'rnaseqc.ab7c51d6d975aac6830f121adb72441a.mugqic.done'
...
rnaseqc.ab7c51d6d975aac6830f121adb72441a.mugqic.done
)
...
JOB_DONE=job_output/wiggle/wiggle.DEX_shSMC1A_3.forward.106b1e6d74f9b82d895ae2dde82cb777.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'wiggle.DEX_shSMC1A_3.forward.106b1e6d74f9b82d895ae2dde82cb777.mugqic.done'
module load mugqic/samtools/1.3.1 mugqic/bedtools/2.25.0 mugqic/ucsc/v326 && \
mkdir -p tracks/DEX_shSMC1A_3 tracks/bigWig && \
...
wiggle.DEX_shSMC1A_3.forward.106b1e6d74f9b82d895ae2dde82cb777.mugqic.done
)
...
JOB_DONE=job_output/wiggle/wiggle.DEX_shSMC1A_3.reverse.6c272eef49c95c71f1c3c0078d65160b.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'wiggle.DEX_shSMC1A_3.reverse.6c272eef49c95c71f1c3c0078d65160b.mugqic.done'
module load mugqic/samtools/1.3.1 mugqic/bedtools/2.25.0 mugqic/ucsc/v326 && \
mkdir -p tracks/DEX_shSMC1A_3 tracks/bigWig && \
...
wiggle.DEX_shSMC1A_3.reverse.6c272eef49c95c71f1c3c0078d65160b.mugqic.done
)
...
JOB_DONE=job_output/wiggle/wiggle.ETOH_shSMC1A_3.forward.bc1e4a3c97d89282c5ef72be6fd4f2e2.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'wiggle.ETOH_shSMC1A_3.forward.bc1e4a3c97d89282c5ef72be6fd4f2e2.mugqic.done'
module load mugqic/samtools/1.3.1 mugqic/bedtools/2.25.0 mugqic/ucsc/v326 && \
mkdir -p tracks/ETOH_shSMC1A_3 tracks/bigWig && \
...
wiggle.ETOH_shSMC1A_3.forward.bc1e4a3c97d89282c5ef72be6fd4f2e2.mugqic.done
)
...
JOB_DONE=job_output/wiggle/wiggle.ETOH_shSMC1A_3.reverse.261badd49daa70dfac985986d2d04739.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'wiggle.ETOH_shSMC1A_3.reverse.261badd49daa70dfac985986d2d04739.mugqic.done'
module load mugqic/samtools/1.3.1 mugqic/bedtools/2.25.0 mugqic/ucsc/v326 && \
mkdir -p tracks/ETOH_shSMC1A_3 tracks/bigWig && \
...
wiggle.ETOH_shSMC1A_3.reverse.261badd49daa70dfac985986d2d04739.mugqic.done
)
...
JOB_DONE=job_output/raw_counts/htseq_count.DEX_shSMC1A_3.d788f23a20e7cb8aaed60833ebd91556.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
...
JOB_DONE=job_output/raw_counts/htseq_count.ETOH_shSMC1A_3.148fb66ebed515441801e53b9f0330e7.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
...
JOB_DONE=job_output/cufflinks/cufflinks.DEX_shSMC1A_3.9a2bc3d06634af32cb6140039d04c741.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'cufflinks.DEX_shSMC1A_3.9a2bc3d06634af32cb6140039d04c741.mugqic.done'
module load mugqic/cufflinks/2.2.1 && \
...
cufflinks -q  \
  ...
  --num-threads 12 \
  alignment/DEX_shSMC1A_3/DEX_shSMC1A_3.sorted.mdup.hardClip.bam
cufflinks.DEX_shSMC1A_3.9a2bc3d06634af32cb6140039d04c741.mugqic.done
)
...
JOB_DONE=job_output/cufflinks/cufflinks.ETOH_shSMC1A_3.426778c1eda8e59db85df4740d08cba4.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'cufflinks.ETOH_shSMC1A_3.426778c1eda8e59db85df4740d08cba4.mugqic.done'
module load mugqic/cufflinks/2.2.1 && \
...
cufflinks -q  \
  ...
  --num-threads 12 \
  alignment/ETOH_shSMC1A_3/ETOH_shSMC1A_3.sorted.mdup.hardClip.bam
cufflinks.ETOH_shSMC1A_3.426778c1eda8e59db85df4740d08cba4.mugqic.done
)
...
JOB_DONE=job_output/cuffmerge/cuffmerge.9e6b9ee3407bb481becc0ca279c42686.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'cuffmerge.9e6b9ee3407bb481becc0ca279c42686.mugqic.done'
module load mugqic/cufflinks/2.2.1 && \
...
cuffmerge.9e6b9ee3407bb481becc0ca279c42686.mugqic.done
)
...
JOB_DONE=job_output/cuffdiff/cuffdiff.Dex_vs_EtOH-All.081cce72cbe1f627a6c81d0228a9cae3.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'cuffdiff.Dex_vs_EtOH-All.081cce72cbe1f627a6c81d0228a9cae3.mugqic.done'
module load mugqic/cufflinks/2.2.1 && \
...
cuffdiff.Dex_vs_EtOH-All.081cce72cbe1f627a6c81d0228a9cae3.mugqic.done
)
...
JOB_DONE=job_output/cuffdiff/cuffdiff.Dex_vs_EtOH-shSMC1A.ec00045813a7afd67c63731851d87e99.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'cuffdiff.Dex_vs_EtOH-shSMC1A.ec00045813a7afd67c63731851d87e99.mugqic.done'
module load mugqic/cufflinks/2.2.1 && \
...
cuffdiff.Dex_vs_EtOH-shSMC1A.ec00045813a7afd67c63731851d87e99.mugqic.done
)
...
JOB_DONE=job_output/cuffdiff/cuffdiff.Dex_vs_EtOH-shSMC1A-3.9c191806b9a7cb3facadce0f50f4e38d.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'cuffdiff.Dex_vs_EtOH-shSMC1A-3.9c191806b9a7cb3facadce0f50f4e38d.mugqic.done'
module load mugqic/cufflinks/2.2.1 && \
...
cuffdiff -u \
  ...
  cufflinks/ETOH_shSMC1A_3/abundances.cxb \
  cufflinks/DEX_shSMC1A_3/abundances.cxb
cuffdiff.Dex_vs_EtOH-shSMC1A-3.9c191806b9a7cb3facadce0f50f4e38d.mugqic.done
)
...
JOB_DONE=job_output/cuffdiff/cuffdiff.shMED1_vs_shMamm-EtOH.f057c313170042d2f4cf0407f5f5a032.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'cuffdiff.shMED1_vs_shMamm-EtOH.f057c313170042d2f4cf0407f5f5a032.mugqic.done'
module load mugqic/cufflinks/2.2.1 && \
...
cuffdiff -u \
  ...
  cufflinks/ETOH_nonMamm_1/abundances.cxb,cufflinks/ETOH_nonMamm_2/abundances.cxb \
  cufflinks/ETOH_shMED1_1/abundances.cxb,cufflinks/ETOH_shMED1_2/abundances.cxb
cuffdiff.shMED1_vs_shMamm-EtOH.f057c313170042d2f4cf0407f5f5a032.mugqic.done
)
...
JOB_DONE=job_output/cuffdiff/cuffdiff.shNIPBL_vs_shMamm-Dex.8b5119db564a9e7baed236b2fa56d778.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'cuffdiff.shNIPBL_vs_shMamm-Dex.8b5119db564a9e7baed236b2fa56d778.mugqic.done'
module load mugqic/cufflinks/2.2.1 && \
...
cuffdiff -u \
  ...
  cufflinks/DEX_nonMamm_1/abundances.cxb \
  cufflinks/DEX_shNIPBL_1/abundances.cxb
cuffdiff.shNIPBL_vs_shMamm-Dex.8b5119db564a9e7baed236b2fa56d778.mugqic.done
)
...
JOB_DONE=job_output/cuffdiff/cuffdiff.shNIPBL_vs_shMamm-EtOH.44896b5f988240ae87719efde05c9ca8.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'cuffdiff.shNIPBL_vs_shMamm-EtOH.44896b5f988240ae87719efde05c9ca8.mugqic.done'
module load mugqic/cufflinks/2.2.1 && \
...
cuffdiff -u \
  ...
  cufflinks/ETOH_nonMamm_1/abundances.cxb,cufflinks/ETOH_nonMamm_2/abundances.cxb \
  cufflinks/ETOH_shNIPBL_1/abundances.cxb,cufflinks/ETOH_shNIPBL_2/abundances.cxb
cuffdiff.shNIPBL_vs_shMamm-EtOH.44896b5f988240ae87719efde05c9ca8.mugqic.done
)
...
JOB_DONE=job_output/cuffdiff/cuffdiff.shSMC1A-3_vs_shMamm-Dex.751b907fe8a6a7c154870c1b039519a7.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'cuffdiff.shSMC1A-3_vs_shMamm-Dex.751b907fe8a6a7c154870c1b039519a7.mugqic.done'
module load mugqic/cufflinks/2.2.1 && \
...
cuffdiff -u \
  ...
  cufflinks/DEX_nonMamm_1/abundances.cxb \
  cufflinks/DEX_shSMC1A_3/abundances.cxb
cuffdiff.shSMC1A-3_vs_shMamm-Dex.751b907fe8a6a7c154870c1b039519a7.mugqic.done
)
...
JOB_DONE=job_output/cuffdiff/cuffdiff.shSMC1A_vs_shMamm-EtOH.53d0985d755bcbeba4e96898ef0f7198.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'cuffdiff.shSMC1A_vs_shMamm-EtOH.53d0985d755bcbeba4e96898ef0f7198.mugqic.done'
module load mugqic/cufflinks/2.2.1 && \
...
cuffdiff -u \
  ...
  cufflinks/ETOH_nonMamm_1/abundances.cxb,cufflinks/ETOH_nonMamm_2/abundances.cxb \
  cufflinks/ETOH_shSMC1A_3/abundances.cxb,cufflinks/ETOH_shSMC1A_2/abundances.cxb
cuffdiff.shSMC1A_vs_shMamm-EtOH.53d0985d755bcbeba4e96898ef0f7198.mugqic.done
)
...
JOB_DONE=job_output/cuffdiff/cuffdiff.shSMC1A-3_vs_shMamm-EtOH.b25642c1f7793019f845feb362646766.mugqic.done
JOB_OUTPUT_RELATIVE_PATH=$STEP/${JOB_NAME}_$TIMESTAMP.o
JOB_OUTPUT=$JOB_OUTPUT_DIR/$JOB_OUTPUT_RELATIVE_PATH
COMMAND=$(cat << 'cuffdiff.shSMC1A-3_vs_shMamm-EtOH.b25642c1f7793019f845feb362646766.mugqic.done'
module load mugqic/cufflinks/2.2.1 && \
...
cuffdiff -u \
  ...
  cufflinks/ETOH_nonMamm_1/abundances.cxb,cufflinks/ETOH_nonMamm_2/abundances.cxb \
  cufflinks/ETOH_shSMC1A_3/abundances.cxb
cuffdiff.shSMC1A-3_vs_shMamm-EtOH.b25642c1f7793019f845feb362646766.mugqic.done
)
