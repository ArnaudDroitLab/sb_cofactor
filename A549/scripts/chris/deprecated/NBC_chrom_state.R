...
###
assign_chrom_state <- function(regions, chrom_state, simplify = FALSE) {
...
nbc_spectrl_chrom <- assign_chrom_state(nbc_spectrl, chrom_state_hg38, simplify = TRUE)
nbc_common_chrom <- assign_chrom_state(nbc_common, chrom_state_hg38, simplify = TRUE)
nbc_spedex_chrom <- assign_chrom_state(nbc_spedex, chrom_state_hg38, simplify = TRUE)

nbc_spectrl_chrom <- assign_chrom_state(nbc_spectrl, chrom_state_hg38)
nbc_common_chrom <- assign_chrom_state(nbc_common, chrom_state_hg38)
nbc_spedex_chrom <- assign_chrom_state(nbc_spedex, chrom_state_hg38)
