...
EP300_gaps_bckd <- retrieve_sumcount("count_total_EP300_gaps_background.txt")
EP300_vs <- data.frame(EP300, EP300_gaps_bckd)
EP300_ratio <- EP300/EP300_gaps_bckd

GR <- retrieve_sumcount("count_total_GR2.txt")
GR_gaps_bckd <- retrieve_sumcount("count_total_GR_gaps_background.txt")
names(GR) <- names(GR_gaps_bckd)
GR_vs <- data.frame(GR, GR_gaps_bckd)
GR_ratio <- GR/GR_gaps_bckd
